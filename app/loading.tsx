...
export default function Loading() {
  return (
    <div className="h-screen w-full bg-black flex flex-col items-center justify-center gap-4 z-50">
      <div className="relative">
        {/* Outer Glow */}
        <div className="absolute inset-0 bg-blue-500/30 blur-xl rounded-full"></div>
        <Loader2 className="relative z-10 text-blue-500 animate-spin" size={48} />
      </div>
