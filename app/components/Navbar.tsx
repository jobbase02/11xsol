        ...
        >
          ...
          >
            <div className="relative w-8 h-8 flex items-center justify-center">
              ...
              <span className="relative z-10 text-blue-500 font-bold text-sm">
                11X
              </span>
            </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              href="#contact"
              className="relative overflow-hidden px-6 py-2.5 bg-blue-600 text-white text-sm font-bold rounded-full group hover:bg-blue-500 transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)]"
            >
