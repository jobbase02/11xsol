...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen bg-white text-zinc-700 font-sans selection:bg-blue-500/30">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-32">
        <Link href="/" className="inline-flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-900 transition-colors mb-12">
        ...
        <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-4xl font-bold text-zinc-900 font-almarena">Privacy Protocol</h1>
        </div>

        <div className="space-y-8 text-sm md:text-base leading-relaxed">
            <p className="text-zinc-500">Last Updated: December 2025</p>
            ...
            <section>
                <h2 className="text-xl font-bold text-zinc-900 mb-4">2. Usage of Information</h2>
            ...
            <section>
                <h2 className="text-xl font-bold text-zinc-900 mb-4">5. Contact</h2>
                <p>For privacy concerns, contact our Data Officer at <a href="mailto:privacy@elevenxsolutions.com" className="text-blue-600 hover:underline">privacy@elevenxsolutions.com</a>.</p>
            </section>
        </div>
      </div>
    </div>
