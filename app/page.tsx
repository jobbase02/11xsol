  ...
  return (
    <section className="relative min-h-screen flex items-center pt-28 overflow-hidden bg-black selection:bg-blue-600/30">
      ...
      <div className="max-w-7xl mx-auto px-6 w-full z-10 grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
        ...
        >
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-950/30 border border-blue-500/30 text-blue-400 text-sm font-semibold backdrop-blur-sm">
          ...
          <motion.h1 variants={fadeInUp} className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight">
            We Build Digital <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 animate-gradient-x">Products</span> That Dominate.
          </motion.h1>
          
          <motion.p variants={fadeInUp} className="text-lg md:text-xl text-zinc-400 max-w-xl leading-relaxed">
            11XSolutions transforms ambitious ideas into scalable, high-performance web applications. Zero fluff, 100% engineering excellence.
          </motion.p>
          
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4">
            <a href="#contact" className="px-8 py-4 bg-white text-black font-bold text-lg rounded-xl hover:bg-blue-50 transition-all flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]">
              Start Project <ArrowRight size={20} />
            </a>
            <a href="#portfolio" className="px-8 py-4 bg-zinc-900 border border-zinc-800 text-white font-medium text-lg rounded-xl hover:bg-zinc-800 hover:border-zinc-700 transition-all flex items-center justify-center">
              View Work
            </a>
          </motion.div>
            ...
            <div className="relative w-full max-w-lg aspect-[4/5] md:aspect-square lg:aspect-[4/5]">
                ...
                <div className="absolute inset-0 bg-zinc-900/90 backdrop-blur-xl border border-white/10 rounded-[2rem] shadow-2xl overflow-hidden flex flex-col">
                    ...
                    <div className="p-6 border-b border-white/5 flex justify-between items-center">
                      ...
                      <div className="text-xs font-mono text-zinc-500">server-main.tsx</div>
                    </div>
                    ...
                    <div className="flex-1 p-6 md:p-8 font-mono text-sm md:text-base space-y-4 overflow-hidden relative">
                        ...
                        <div className="flex gap-3">
                           ...
                           <span className="text-purple-400">interface</span> <span className="text-yellow-100">Performance</span> {'{'}
                        </div>
                        <div className="flex gap-3">
                           <span className="text-zinc-600">02</span>
                           <span className="pl-4 text-blue-400">speed:</span> <span className="text-green-400">'Lightning'</span>;
                        </div>
                        <div className="flex gap-3">
                           <span className="text-zinc-600">03</span>
                           <span className="pl-4 text-blue-400">security:</span> <span className="text-green-400">'FortKnox'</span>;
                        </div>
                        <div className="flex gap-3">
                           <span className="text-zinc-600">04</span>
                           <span className="pl-4 text-blue-400">scale:</span> <span className="text-green-400">'Infinite'</span>;
                        </div>
                        <div className="flex gap-3">
                        ...
                        <div className="mt-8 p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                           <div className="text-blue-300 text-xs uppercase mb-2">Deploy Status</div>
  ...
  return (
    <section id="services" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Expertise That Matters</h2>
          <p className="text-zinc-400 max-w-2xl mx-auto text-lg">We don't use templates. We architect solutions tailored to your specific operational needs.</p>
        </motion.div>
        ...
        >
          {services.map((service, index) => (
            ...
            >
              <div className={`absolute top-0 right-0 w-32 h-32 ${service.color} opacity-10 rounded-bl-full blur-2xl group-hover:opacity-20 transition-opacity`}></div>
              
              <div className={`mb-6 p-4 ${service.color} w-fit rounded-2xl shadow-lg`}>
                {service.icon}
              </div>
              <h3 className="text-xl font-bold text-white mb-4">{service.title}</h3>
              <p className="text-zinc-400 text-sm leading-relaxed mb-6">{service.desc}</p>
              
              <a href="#" className="inline-flex items-center gap-2 text-sm font-semibold text-white/50 group-hover:text-white transition-colors">
  ...
  const projects = [
    {
      title: "CryptoDash",
      category: "FinTech",
      image: "https://images.unsplash.com/photo-1642104704074-907c0698b98d?auto=format&fit=crop&q=80&w=600&h=400",
      tech: ["Next.js", "Web3.js"]
    },
    {
      title: "Vessel",
      category: "Logistics",
      image: "https://images.unsplash.com/photo-1494412574643-35d324698420?auto=format&fit=crop&q=80&w=600&h=400",
      tech: ["React", "Mapbox"]
    },
    {
      title: "LuxeStay",
      category: "Real Estate",
      image: "https://images.unsplash.com/photo-1600596542815-60c37c663d12?auto=format&fit=crop&q=80&w=600&h=400",
      tech: ["Supabase", "Stripe"]
    }
  ];

  return (
    <section id="portfolio" className="py-24 bg-zinc-950 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          >
            ...
            <p className="text-zinc-400 max-w-xl">We let our code speak for itself. Here are a few projects we've recently deployed.</p>
          </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-blue-500 transition-colors">{project.title}</h3>
              <div className="flex gap-2">
                {project.tech.map(t => (
                  <span key={t} className="text-xs text-zinc-500 border border-zinc-800 px-2 py-1 rounded">{t}</span>
                ))}
              </div>
            </motion.div>
          ))}
    ...
    <section id="pricing" className="py-24 bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-zinc-400">Clear pricing for every stage of your business growth.</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-8 min-h-[40px]">Get your idea to market quickly with a high-performance landing page or basic app.</p>
            
            <div className="space-y-4 mb-8">
              {['React/Next.js Landing Page', 'Mobile Responsive', 'SEO Basic Setup', 'Contact Forms', '1 Month Support'].map((item) => (
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-8 min-h-[40px]">Full-featured web application with authentication, database, and dynamic content.</p>
            
            <div className="space-y-4 mb-8">
              {['Everything in MVP', 'User Authentication (Auth0/Supabase)', 'Admin Dashboard', 'Payment Integration', 'Database Design'].map((item) => (
          ...
          >
            ...
            <p className="text-zinc-400 text-sm mb-8 min-h-[40px]">For established organizations requiring complex architecture and dedicated teams.</p>
            
            <div className="space-y-4 mb-8">
              {['Dedicated Development Team', 'Microservices Architecture', 'Legacy System Migration', 'SLA Support', 'Advanced Security Audit'].map((item) => (
                <div key={item} className="flex items-center gap-3 text-zinc-300 text-sm">
                   <div className="w-5 h-5 rounded-full bg-blue-900/30 flex items-center justify-center">
                    <CheckCircle2 size={12} className="text-blue-500" />
                  </div>
  ...
  return (
    <section className="py-24 bg-zinc-950 overflow-hidden relative border-y border-white/5">
      <div className="max-w-7xl mx-auto px-6 mb-12">
        <h2 className="text-3xl font-bold text-white text-center">Trusted by Industry Leaders</h2>
      </div>
            ...
            {extendedTestimonials.map((item, i) => (
              ...
              >
                <div>
                   ...
                   <p className="text-zinc-300 text-lg leading-relaxed mb-6">"{item.text}"</p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-zinc-800 rounded-full overflow-hidden border border-white/10">
                    <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${item.img}&backgroundColor=transparent`} alt={item.name} />
                  </div>
                  <div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Let's Build Something <br/> Legendry.</h2>
            <p className="text-zinc-400 text-lg mb-10 max-w-md">Ready to scale? We are currently accepting 2 new enterprise clients for Q1 2025.</p>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4 text-zinc-300 group">
                ...
                <div>
                  <p className="text-xs text-zinc-500 uppercase tracking-wide mb-1">Call Us</p>
          ...
          >
            {formState === 'success' ? (
              <div className="h-full flex flex-col items-center justify-center text-center py-12 min-h-[400px]">
                ...
                <p className="text-zinc-400">Our team will review your request and reply within 24 hours.</p>
                <button 
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input required type="text" className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all placeholder:text-zinc-700" placeholder="John Doe" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-zinc-400">Email</label>
                    <input required type="email" className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all placeholder:text-zinc-700" placeholder="john@company.com" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-zinc-400">Service Interest</label>
                ...
                <div className="space-y-2">
                  ...
                  <textarea required rows="4" className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-4 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all placeholder:text-zinc-700 resize-none" placeholder="Tell us about your project..."></textarea>
                </div>
                <button 
    ...
    <footer className="bg-black pt-20 pb-10 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
          <div className="max-w-xs">
            <a href="#" className="text-2xl font-bold tracking-tighter text-white flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center text-black font-bold">11</div>
              XSolutions
            </a>
            <p className="text-zinc-500 text-sm leading-relaxed">
              Premium web development agency building the next generation of digital products.
            </p>
          </div>
          ...
          <div className="flex gap-4">
            <a href="#" className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-400 hover:bg-blue-600 hover:text-white transition-all"><Github size={18} /></a>
            <a href="#" className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-400 hover:bg-blue-600 hover:text-white transition-all"><Twitter size={18} /></a>
            <a href="#" className="w-10 h-10 rounded-full bg-zinc-900 flex items-center justify-center text-zinc-400 hover:bg-blue-600 hover:text-white transition-all"><Linkedin size={18} /></a>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-zinc-600">
          <p>&copy; {new Date().getFullYear()} 11XSolutions Agency. All rights reserved.</p>
