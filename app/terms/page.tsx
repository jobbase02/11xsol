    ...
    <div className="min-h-screen bg-white text-zinc-700 font-sans selection:bg-blue-500/30">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-32">
        ...
        <div className="flex items-center gap-4 mb-8">
            ...
            <h1 className="text-4xl font-bold text-zinc-900 font-almarena">Terms of Service</h1>
        </div>

        <div className="space-y-8 text-sm md:text-base leading-relaxed">
            <section>
                <h2 className="text-xl font-bold text-zinc-900 mb-4">1. Agreement</h2>
                <p>By accessing elevenxsolutions.com, you agree to these Terms. If you disagree, do not use our services.</p>
            </section>

            <section>
                <h2 className="text-xl font-bold text-zinc-900 mb-4">2. Services</h2>
            ...
            <section>
                <h2 className="text-xl font-bold text-zinc-900 mb-4">3. Intellectual Property</h2>
                <p>
            ...
            <section>
                <h2 className="text-xl font-bold text-zinc-900 mb-4">4. Liability</h2>
                <p>
